...
const apiKey = '85a9f952eeba1231fd969b0e414b4873'
...
function updateForecastItems(weatherData){
    ...
    const dateResult = dateTaken.toLocaleDateString('en-US',dataOption)

    const forecastItem = `
            <div class="forecast-item">
                <h5 class="forecate-item-date regular-txt">${dateResult}</h5>
                <img src="${getWeatherIcon(id)}" class="forecast-item-img">
                <h5 class="forecast-items-temp">${Math.round(temp)} &deg; C</h5>
            </div>
    `
